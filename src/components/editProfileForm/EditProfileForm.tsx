...
const EditProfileForm: FC<EditProfileFormProps> = ({ isMobile }) => {
    ...
    const [userInfo, setUserInfo] = useState({ user_name: '', email: '', description: '', twitter: '', favorite: '' })
